    ...
    >
      <div className="section-shell">
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: '80px' }}>
          ...
          >
            <p className="label-caps" style={{ marginBottom: '14px' }}>Community</p>
            <h2
              style={{
            ...
            <p style={{ fontSize: '13px', lineHeight: 1.75, color: 'rgba(240,240,240,0.38)', maxWidth: '24ch' }}>
              Follow us for new releases, behind-the-scenes and label updates.
            </p>
          </motion.div>
              ...
              >
                <div
                  style={{
                    ...
                    gap: '16px',
                    padding: '16px 0',
                    borderBottom: index < socials.length - 1 ? '1px solid rgba(255,255,255,0.05)' : 'none',
                    cursor: 'pointer',
                ...
                >
                  ...
                  <span style={{ fontSize: '12px', color: 'rgba(240,240,240,0.28)' }}>
                    {social.handle}
                  </span>
