...
const SOCIALS: Social[] = [
  {
    name: 'Instagram',
    handle: '@nothing_records',
    href: 'https://instagram.com/nothing_records',
    contexts: ['artist update', 'new story', 'photo drop'],
    Icon: InstagramLogo,
  },
  {
    name: 'TikTok',
    handle: '@nothing_manager',
    href: 'https://tiktok.com/@nothing_manager',
  ...
  },
  {
    ...
    contexts: ['promo', 'slowed songs', 'cool sounds', 'new tracks'],
    Icon: TiktokLogo,
  },
  {
    name: 'Telegram',
